...
Проект создан с использованием HTML, CSS и JavaScript. Основные файлы: - `index.html`: Основная страница. - `css/style.css`: стили для тёмной темы и оформления. - `js/script.js`: логика игры, включая уровни, проверки селекторов и управление подсказками. 
